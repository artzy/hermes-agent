...
| `TOGETHER_API_KEY` | Together AI API key ([api.together.ai](https://api.together.ai/settings/api-keys)). Provider: `together` (aliases: `togetherai`, `together-ai`). |
| `TOGETHER_BASE_URL` | Override Together AI base URL (default: `https://api.together.ai/v1`) |
